...
export default function AddCountryForm() {
  ...
  const addCountryMutation = useMutation({
    ...trpc.countries.add.mutationOptions(),
    onSuccess: () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const body = {
      ...
      dialcode: parseInt(formData.get('dial') as string),
      active,
    }

    addCountryMutation.mutate(body)
      ...
      <form onSubmit={handleSubmit} className="w-full">
        <Card className="w-full">
          ...
          <CardFooter className="flex flex-col items-start">
            <Button type="submit" className="w-full" disabled={addCountryMutation.isPending}>
